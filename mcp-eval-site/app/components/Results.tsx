  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="mt-12 mb-8 bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden">
          ...
          <div className="grid md:grid-cols-2 divide-x divide-slate-200">
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h4 className="text-base font-semibold text-slate-900 mb-1 group-hover:text-purple-600 transition-colors">
